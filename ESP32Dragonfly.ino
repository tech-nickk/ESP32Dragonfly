...
void setup()
{
  ...
  #ifdef HAS_SCREEN
    #ifndef MARAUDER_MINI
      display_obj.drawJpeg("/dragonfly.jpg", 0 , 0);     // 240 x 320 image
    #else
      display_obj.drawJpeg("/dragonfly.jpg", 0, 0);
    #endif
  #endif

  #ifdef HAS_SCREEN
    #ifndef MARAUDER_MINI
      display_obj.tft.drawCentreString(display_obj.version_number, 120, 150, 2);
    #endif
  ...
  backlightOn(); // Need this
    ...
    display_obj.tft.println("Dragonfly " + display_obj.version_number + "\n");
